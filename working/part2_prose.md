...
2. **After delivery:** a two-state timeline — *Delivered → Welcomed* — visible to the purchaser. The signal the purchaser actually needs (it landed; it was met with a real Welcome) without crossing into surveillance of what the giftee did next. A "Planned" state would be informative but leaks more than a cautious giftee would accept; privacy beats marginal purchaser reassurance.

**Connection to the giftee redesign.** This works *only because* the giftee experience now has a Welcome worth previewing — the purchaser's preview at gift purchase is the same artifact the giftee will see. The purchaser confidence improvement is downstream of the giftee redesign — the same product feature seen from two sides. Repeat gifting follows directly: the purchaser who sees their gift land well is the most likely person to gift again.
